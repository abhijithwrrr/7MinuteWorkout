...
import com.abhijith.a7minuteworkout.databinding.ActivityBmiBinding
...
class BMIActivity : AppCompatActivity() {
    ...
    private var currentVisibleView: String =
        METRIC_UNITS_VIEW // A variable to hold a value to make a selected variable visible
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.btnCalculateUnits?.setOnClickListener {
            if (validateMetricUnits()) {
                ...
                // dividing by 100 is used to get the height in metres while we enter in cms
