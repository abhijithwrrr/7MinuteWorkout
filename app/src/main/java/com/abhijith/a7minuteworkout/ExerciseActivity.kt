...
import com.abhijith.a7minuteworkout.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.abhijith.a7minuteworkout" + R.raw.press_start)
        ...
        /**
         * Here firstly I'm check if the timer is running the and it is not null then cancel the running timer and start the new one.
    ...
    private fun setupExerciseView() {
        ...
        /**
         * Here firstly I will check if the timer is running and it is not null then cancel the running timer and start the new one.
